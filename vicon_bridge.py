...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if msg.get_type() == 'LOCAL_POSITION_NED_COV':
            ...
            theta = 60 * 3.14 / 180  # body frame rotate w.r.t global frame
            x_p   = -0.946 # body origin move w.r.t. global frame along x 
            y_p   = -1.761   # body origin move w.r.t. global frame along y
            ...
            yaw_new = pi_2_pi(round(data.data[9]+theta, 3))
